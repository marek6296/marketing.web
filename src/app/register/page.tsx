          ...
          {registered ? (
            ...
            <div className="card" style={{ padding: 36, textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 24 }}>
                Poslali sme ti potvrdzovací email. Klikni na odkaz v emaili pre aktiváciu účtu.
              </p>
              <Link
                href="/login"
                className="btn-primary"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 6, justifyContent: 'center', padding: '10px 24px', borderRadius: 10, textDecoration: 'none', fontSize: 14 }}
              >
                Prejsť na prihlásenie <ArrowRight size={14} />
              </Link>
            </div>
          ) : (
            /* ── Registration form ── */
